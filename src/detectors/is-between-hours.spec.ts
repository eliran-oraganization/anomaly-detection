...
import IsBetweenHours from "./is-between-hours";
...
describe('Push Events', () => {
    ...
    describe('Push rules', () => {
        ...
        it('Push should be detect as anomaly when created between 14:00 - 16:00', () => {
            ...
            situations.forEach(situation => expect(detector.detect(situation.repository.pushed_at)).toBe(true));
        });
        it('Push should not be detect as anomaly if it was created before 14:00 or after 16:00', () => {
            ...
            situations.forEach(situation => expect(detector.detect(situation.repository.pushed_at)).toBe(false));
